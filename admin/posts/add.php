...
<script>
    tinymce.init({
        ...
        toolbar: 'undo redo | blocks styles fontfamily fontsize | bold italic underline strikethrough | link image media table | align lineheight | checklist numlist bullist indent outdent | ltr rtl | emoticons charmap | removeformat',
        style_formats: [
